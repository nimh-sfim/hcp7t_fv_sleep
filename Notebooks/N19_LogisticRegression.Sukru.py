...
(ET_PupilSize_Proc_1Hz[sample_scan].hvplot(xformatter=formatter, width=1500, height=250, title='Pupil Size Trace', fontsize={'labels':14, 'ticks':14, 'title':18}, c='#4472C4', line_width=3,axis_line_color='green') + \
EC_Windowed[sample_scan].hvplot(xformatter=formatter, width=1500, shared_axes=False, height=250, title='Percentage of Eye Closure per window', fontsize={'labels':14, 'ticks':14, 'title':18}, c='#4472C4', line_width=3) +
EC_Windowed_Labels[sample_scan].hvplot(xformatter=formatter, width=1500, height=250, shared_axes=False, title='Classification labels', fontsize={'labels':14, 'ticks':14, 'title':18}, c='#4472C4', line_width=3)).cols(1)
...
PSD_Windowed[sample_scan].hvplot(xformatter=formatter, width=1500, height=250, title='Windowed PSDsleep', fontsize={'labels':14, 'ticks':14, 'title':18}, c='#4472C4', line_width=3, shared_axis=False)

GS_Windowed['Basic'][sample_scan].hvplot(xformatter=formatter, width=1500, height=250, title='GSamplitude', fontsize={'labels':14, 'ticks':14, 'title':18}, c='#4472C4', line_width=3)
