...
# (8) Create resampled version of the Schaefer atlas into the FIX grid
# =====================================================================
echo "++ INFO: (8) Create resampled version of the Schaefer atlas into the FIX grid"
echo "============================================================================="
...
# (10) We then constrain the Atlas to the GM ribbon of each particular subject
# ===========================================================================
echo "++ INFO: (10) We then constrain the Atlas to the GM ribbon of each particular subject"
echo "====================================================================================="
